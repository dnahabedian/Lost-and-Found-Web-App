...
submitButton.addEventListener("click", ()=>{
  ...
  window.sessionStorage.setItem("finderInputDate", document.getElementById("date").value);
  window.sessionStorage.setItem("finderInputTime", document.getElementById("time").value);
  window.sessionStorage.setItem("finderInputLocation", document.getElementById("location-input-box").value);
  let post = {
    "title": window.sessionStorage.getItem("finderInputTitle"),
    "photo": window.sessionStorage.getItem("finderInputPhoto"),
    "category": window.sessionStorage.getItem("finderInputCategory"),
    "location": window.sessionStorage.getItem("finderInputLocation"),
    "date": window.sessionStorage.getItem("finderInputDate"),
    "time": window.sessionStorage.getItem("finderInputTime"),
    "comment": window.sessionStorage.getItem("finderInputComment")
  }
  let xhr = new XMLHttpRequest()
  xhr.open("POST", "/insertFoundItem");
  xhr.setRequestHeader("Content-Type", "application/json;charset=UTF-8");
  xhr.send(JSON.stringify(post));
  xhr.onloadend = function(e) {
    window.location.href = "https://hammerhead-glittery-ceres.glitch.me/user/views/results-seeker.html";
  }
})
